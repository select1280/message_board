...
<body class="container py-5">
  ...
  <div id="messages">
    ...
    $stmt = $pdo->prepare("SELECT * FROM messages WHERE parent_id IS NULL ORDER BY created_at DESC LIMIT :offset, :perPage");
    $stmt->bindValue(':offset', $offset, PDO::PARAM_INT);
    $stmt->bindValue(':perPage', $perPage, PDO::PARAM_INT);
    $stmt->execute();

    $total = $pdo->query("SELECT COUNT(*) FROM messages WHERE parent_id IS NULL")->fetchColumn();
